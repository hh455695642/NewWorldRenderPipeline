...
namespace Beautify.Universal {
    ...
    public static class ShaderParams {
        ...
        public static int vignetteData3 = Shader.PropertyToID("_VignettingData3");
        ...
        public const string SKW_SMH = "BEAUTIFY_SMH";
        ...
        public static int smhShadows = Shader.PropertyToID("_SMHShadows");
        public static int smhMidtones = Shader.PropertyToID("_SMHMidtones");
        public static int smhHighlights = Shader.PropertyToID("_SMHHighlights");
        public static int smhRange = Shader.PropertyToID("_SMHRange");
    }
            ...
            static void ExecutePass (PassData passData) {
                ...
                if (usesDirectWriteToCamera) {
                    ...
                    if (beautify.debugOutput.value == DebugOutput.DepthOfFieldCoC) {
                        ...
                        if (beautify.bloomIntensity.value > 0 || beautify.sunFlaresIntensity.value > 0 || beautify.lensDirtIntensity.value > 0) {
                            // we ignore input contents
...
#pragma warning restore 0618
            ...
            static void DoBloomAndFlares (CommandBuffer cmd, bool dofAffectsBloom) {
                ...
                if (beautify.lensDirtIntensity.value > 0 || beautify.bloomIntensity.value > 0 || sunFlareEnabled) {
                    ...
                    if (sunFlareEnabled) {
                        ...
                        if (beautify.bloomIntensity.value <= 0) { // ensure _Bloom.x is 1 into the shader for sun flares to be visible if no bloom is enabled
                    ...
                    if (beautify.lensDirtIntensity.value > 0) {
                        int rtID = rt[lensDirtSpread].rtUp;
            ...
            static void BlendOneOne (CommandBuffer cmd, int source, ref int destination, ref int tempBuffer) {
                cmd.SetGlobalTexture(ShaderParams.bloomTex, destination); // _BloomTex used as temporary rt for combining
            ...
            public void UpdateMaterialProperties (Camera cam) {
                ...
                bMat.SetVector(ShaderParams.colorParams, new Vector4(0, 0, 0, isOrtho ? 1000.0f : 0f));
                ...
                if (usesVignetting) {
                    ...
                    bMat.SetVector(ShaderParams.vignetteData3, new Vector4(0, 0, vd, innerRing));
                }

                // Eye adaptation
                bool usesEyeAdaptation = beautify.eyeAdaptation.value;
                requiresLuminanceComputation = Application.isPlaying && usesEyeAdaptation;
                if (requiresLuminanceComputation) {
                ...
                // Color tweaks
                if (beautify.colorTempBlend.value > 0) {
                    keywords.Add(ShaderParams.SKW_COLOR_TWEAKS);
                }

                // Shadows Midtones Highlights
                Color smhS = beautify.smhShadows.value;
                Color smhM = beautify.smhMidtones.value;
                Color smhH = beautify.smhHighlights.value;
                if (smhS != Color.white || smhM != Color.white || smhH != Color.white) {
                    keywords.Add(ShaderParams.SKW_SMH);
                    bMat.SetColor(ShaderParams.smhShadows, smhS);
                    bMat.SetColor(ShaderParams.smhMidtones, smhM);
                    bMat.SetColor(ShaderParams.smhHighlights, smhH);
                    bMat.SetVector(ShaderParams.smhRange, new Vector4(beautify.smhShadowsStart.value, beautify.smhShadowsEnd.value, beautify.smhHighlightsStart.value, beautify.smhHighlightsEnd.value));
                }
            ...
            static void UpdateMaterialBloomIntensityAndThreshold () {
                ...
                Vector4 b4 = new Vector4(bloomIntensity, 0, 0, bloomThreshold);
        ...
        [Tooltip("Do not compile Shadows Midtones Highlights shader feature, reducing build time.")]
        public bool stripBeautifySMH;

        [Tooltip("Do not compile Bloom & Sun Flares shader features, reducing build time.")]
        ...
        [Tooltip("Do not compile Eye Adaptation shader feature, reducing build time.")]
        ...
        public void UpdateInternalStripSettings() {
            ...
            m_InternalStripSettings.stripBeautifySMH = stripBeautifySMH;
        ...
        public void SyncInternalToLegacy() {
            ...
            stripBeautifySMH = m_InternalStripSettings.stripBeautifySMH;
        ...
        public void SetStripShaderKeywords () {
            ...
            if (settings.stripBeautifySMH) {
                sb.Append(ShaderParams.SKW_SMH);
            }
