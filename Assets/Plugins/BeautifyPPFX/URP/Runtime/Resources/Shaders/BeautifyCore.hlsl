...
#pragma warning (disable : 3571)
    ...
    float2 _LUT3DParams;
        ...
        #define VIGNETTE_FADE_AND_BLINK _VignettingData3.z
        #define VIGNETTE_INNER_RING _VignettingData3.w
	...
	void beautifyPass(VaryingsBeautify i, inout float3 rgbM) {
        ...
        #if (BEAUTIFY_OUTLINE && !BEAUTIFY_OUTLINE_SOBEL)
		...
		#if UNITY_COLORSPACE_GAMMA && (BEAUTIFY_BLOOM || BEAUTIFY_DIRT || BEAUTIFY_EYE_ADAPTATION || BEAUTIFY_ACES_TONEMAP || BEAUTIFY_AGX_TONEMAP || BEAUTIFY_ACES_FITTED_TONEMAP)
            ...
            rgbM *= eaFactor;
             ...
             rgbM  = saturate(rgbM);
                ...
                rgbM *= _FXColor.g;
                 ...
                 rgbM *= _FXColor.g;
            #endif
    		#if UNITY_COLORSPACE_GAMMA && (BEAUTIFY_BLOOM || BEAUTIFY_DIRT || BEAUTIFY_EYE_ADAPTATION || BEAUTIFY_ACES_FITTED_TONEMAP || BEAUTIFY_ACES_TONEMAP)
        ...
        #if BEAUTIFY_SMH
            float smhLuma = getLuma(rgbM);
            float shadowWeight = 1.0 - smoothstep(_SMHRange.x, _SMHRange.y, smhLuma);
            float highlightWeight = smoothstep(_SMHRange.z, _SMHRange.w, smhLuma);
            float midtoneWeight = 1.0 - shadowWeight - highlightWeight;
            rgbM *= _SMHShadows.rgb * shadowWeight + _SMHMidtones.rgb * midtoneWeight + _SMHHighlights.rgb * highlightWeight;
        #endif
