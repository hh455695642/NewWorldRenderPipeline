...
Subshader {	
  ...
  Pass { // 2  
      ...
      #pragma multi_compile_local_fragment __ BEAUTIFY_LUT BEAUTIFY_3DLUT
      ...
      #pragma multi_compile_local_fragment __ BEAUTIFY_SMH
      ...
      #pragma multi_compile_local_fragment __ BEAUTIFY_OUTLINE
      #include "BeautifyCore.hlsl"
      ENDHLSL
  }
