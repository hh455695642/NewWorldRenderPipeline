    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                half4 maskTex = SampleFxTexture(TEXTURE2D_ARGS(_MaskTex, sampler_MaskTex), maskUV, maskBlendUV, blend);

                half4 baseColor = mainTex * input.color * _Color;
                half maskAlpha = pow(saturate(maskTex.r), _Power1) * _Power2;
