...
namespace NWRP
{
    ...
    public static class NWRPShaderIds
    {
        ...
        public static readonly int CloudShadowTexture0 = Shader.PropertyToID("_NWRPCloudShadowTexture0");
        public static readonly int CloudShadowTexture1 = Shader.PropertyToID("_NWRPCloudShadowTexture1");
        public static readonly int CloudShadowWorldToProjector0 = Shader.PropertyToID("_NWRPCloudShadowWorldToProjector0");
        public static readonly int CloudShadowWorldToProjector1 = Shader.PropertyToID("_NWRPCloudShadowWorldToProjector1");
        public static readonly int CloudShadowUV0 = Shader.PropertyToID("_NWRPCloudShadowUV0");
        public static readonly int CloudShadowUV1 = Shader.PropertyToID("_NWRPCloudShadowUV1");
        public static readonly int CloudShadowParams0 = Shader.PropertyToID("_NWRPCloudShadowParams0");
        public static readonly int CloudShadowParams1 = Shader.PropertyToID("_NWRPCloudShadowParams1");
        public static readonly int CloudShadowColor0 = Shader.PropertyToID("_NWRPCloudShadowColor0");
        public static readonly int CloudShadowColor1 = Shader.PropertyToID("_NWRPCloudShadowColor1");
        public static readonly int CloudShadowDistortionTexture = Shader.PropertyToID("_NWRPCloudShadowDistortionTexture");
        public static readonly int CloudShadowDistortionUV = Shader.PropertyToID("_NWRPCloudShadowDistortionUV");
        public static readonly int CloudShadowDistortionParams = Shader.PropertyToID("_NWRPCloudShadowDistortionParams");
