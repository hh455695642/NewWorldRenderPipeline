// ============================================================
// NewWorld/Lit/BlinnPhong
//
// Blinn-Phong 光照模型 = Lambert 漫反射 + Blinn-Phong 镜面反射 + 环境光
// 镜面反射使用半角向量 H = normalize(L + V) 与法线 N 的点积。
// 比 Phong 计算更快（不需要 reflect），且在掠射角更自然。
// ============================================================

Shader "NewWorld/Lit/BlinnPhong"
{
    Properties
    {
